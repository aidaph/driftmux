...
action = function(host, port)
	...
	if nmap.registry.args.vulscandb then
		...
		db[3] = {name="Exploit-DB",		file="exploitdb.csv",		url="https://www.exploit-db.com",		link="https://www.exploit-db.com/exploits/{id}"}
                db[4] = {name="ApacheHTTP-DB",          file="apachecve.csv",           url="https://www.cvedetails.com/vulnerability-list/vendor_id-45/product_id-66/Apache-Http-Server.html",               link="https://www.cvedetails.com/vulnerability-list/{id}"}
